        ...
        <div class="table-cell align-middle px-5 py-14">
            <div class="box">
                <div class="bg-main border-1 border-stone-500/5 rounded-md shadow-4xl dexoboxregister text-center mx-auto p-10 animate-slide-up sm:w-1/2 md:w-1/3 lg:w-1/4">
                    ...
                    <form name="RegisterForm" action="login.php" method="post" onsubmit="return validateForms()" >
                        ...
                        <div class="mb-3 w-full text-left input-container">
                            ...
                            if(isset($_SESSION['login_err'])) {
                                echo '<p name="password-error" id="password-error" class="text-sm text-red-500 text-left mt-1.5">'. $_SESSION['login_err'] .'</p>';
                        ...
                        <div class="my-4">
                            <button id="registerbtn" class="btn-submit button" type="submit" title="Register">Login</button>
                        </div>
                        <div class="mx-auto my-6 max-w-xs">
                            <p style="color: gray">
                                Dont have an account? <a href="../login">Sign up here</a>.
                            </p>
                        </div>
                    </form>
